  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px", width: "100%" }}>
      ...
      <BaseCard>
        ...
        />
        <CardBody>
          <div style={{ display: "flex", gap: "24px", flexDirection: "row", alignItems: "center", marginBottom: "24px" }}>
             ...
             <div style={{ flex: 1, padding: "20px", background: "#f8fafc", borderRadius: "20px", border: `1px solid ${TOKENS.colors.border}` }}>
