...
export const WizardGuidance: React.FC<WizardGuidanceProps> = ({ 
  ...
  return (
    <div className="animate-in fade-in slide-in-from-left-4 duration-700" style={{
      width: "600px",
      height: "100%",
      display: "flex",
      ...
      <BaseCard isInitiallyOpen={true} style={{
        ...
        padding: "32px",
        boxShadow: `0 0 40px ${themeColor}40, 0 0 100px ${themeColor}15, inset 0 0 20px ${themeColor}05`,
        flex: 1,
        width: "100%",
        cursor: "default"
      }}>
