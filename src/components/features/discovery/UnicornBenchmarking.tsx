...
export const UnicornBenchmarking: React.FC = () => {
  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-700 font-['IBM_Plex_Sans_Arabic']" dir="rtl">
      ...
      {/* ── HEADER ── */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 sm:gap-10 px-4 sm:px-0">
        <div className="flex-1 text-center md:text-right">
          <div className="inline-flex items-center justify-center md:justify-start gap-3 px-4 py-2 bg-violet-50 text-violet-600 rounded-2xl border border-violet-100 shadow-sm mb-6 transition-transform hover:scale-105 cursor-default">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-tight mb-4 uppercase">
            رادار المعايرة العالمية
          </h1>
          <p className="text-slate-500 font-bold text-sm sm:text-base max-w-2xl mx-auto md:mx-0 leading-relaxed italic opacity-80">
      ...
      {/* ── SECTOR SELECTOR ── */}
      <div className="bg-white border-2 border-slate-100 rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/30 ring-1 ring-black/5">
        <div className="flex items-center justify-center md:justify-start gap-4 mb-8">
          ...
          <div className="text-center md:text-right">
            <h2 className="text-lg font-black text-slate-900 leading-none mb-1">اختر قطاع خطة العمل</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div className="lg:col-span-2 bg-slate-950 rounded-[2.5rem] p-8 text-white relative overflow-hidden flex flex-col justify-between min-h-[360px]">
              ...
              <div className="relative z-10">
                ...
                {/* Big Score */}
                <div className="flex items-end justify-center lg:justify-start gap-3 mb-3">
                  <span className="text-6xl sm:text-8xl font-black leading-none" style={{ color: scoreColor }}>
                    <AnimatedCounter target={overallScore} />
                  </span>
                  <span className="text-2xl sm:text-4xl font-black text-slate-600 mb-2">/ 100</span>
                </div>
