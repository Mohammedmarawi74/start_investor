...
export const MyProjects: React.FC = () => {
  ...
  return (
    <div dir="rtl" className="min-h-screen pb-20 font-['IBM_Plex_Sans_Arabic'] animate-in fade-in duration-700">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 mb-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
           <div className="text-center lg:text-right">
              <h1 className="text-3xl font-black text-slate-900 mb-2">إدارة مشاريعي الاستثمارية</h1>
              <p className="text-sm font-bold text-slate-400">تابع تقدم {MOCK_PROJECTS.length} خطط أعمال استراتيجية تحت مجهر الذكاء الاصطناعي.</p>
           </div>
           
           <div className="flex items-center gap-4 bg-white p-2 rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
              <div className="relative group min-w-[280px]">
                 ...
                 <input 
                   ...
                   className="w-full pr-12 pl-4 py-2.5 bg-slate-50 border-none rounded-xl outline-none text-xs font-bold text-slate-800"
                 />
              </div>
              <button className="px-6 py-2.5 bg-blue-600 text-white rounded-xl text-xs font-black shadow-lg shadow-blue-100 flex items-center gap-2 hover:scale-105 active:scale-95 transition-transform">
                 <Plus size={16} />
                 مشروع جديد
              </button>
           </div>
