...
export const SmartAnalyzer: React.FC<SmartAnalyzerProps> = ({ data }) => {
  ...
  return (
    <div dir="rtl" className="min-h-[calc(100vh-80px)] bg-[#F8FAFC] font-['IBM_Plex_Sans_Arabic'] text-slate-900 selection:bg-blue-100 animate-in fade-in duration-500 overflow-y-auto no-scrollbar pb-10">
      ...
      <header className="relative pt-6 pb-8 px-6 lg:px-10 bg-white border-b border-slate-100">
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-right flex-1">
             <div className="inline-flex items-center gap-2 bg-blue-50 px-2.5 py-0.5 rounded-lg border border-blue-100 mb-3">
                <span className="w-1.5 h-1.5 bg-blue-600 rounded-full animate-pulse"></span>
                <span className="text-[9px] font-black text-blue-700 uppercase tracking-widest flex items-center gap-1.5"><Cpu size={10} /> SMART COCKPIT</span>
             </div>
             <h1 className="text-2xl lg:text-3xl font-black text-slate-900 leading-tight">المحلل الاستراتيجي <span className="text-blue-600">الذكي</span></h1>
             <p className="text-slate-400 text-sm font-bold opacity-80 max-w-lg">رؤية استباقية لتحويل الأفكار إلى أصول استثمارية ناجحة.</p>
          </div>
      ...
      <main className="max-w-7xl mx-auto py-8 px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 bg-white border border-slate-100 rounded-[2rem] p-6 lg:p-8 shadow-sm relative overflow-hidden group">
            ...
            <div className="relative z-10 h-full flex flex-col">
               <div className="flex items-center justify-between mb-8">
                  <div>
                    <h3 className="text-lg font-black text-slate-900">موازنة القوى التنافسية</h3>
                    <p className="text-slate-400 font-bold text-[10px]">تحليل هندسي لتوزيع الموارد عبر الأبعاد الخمسة.</p>
                  </div>
                  <div className="w-8 h-8 rounded-lg bg-slate-50 flex items-center justify-center text-slate-400 border border-slate-100"><Maximize2 size={14} /></div>
               </div>
               ...
               <div className="mt-4 flex justify-center gap-6 pt-4 border-t border-slate-50">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-blue-600"></div>
                    <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">المؤشرات الخاصة بك</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-slate-200"></div>
                    <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">متوسط السوق</span>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 flex flex-col">
             <div className="flex-1 bg-slate-900 rounded-[2rem] p-8 text-white relative overflow-hidden group shadow-xl">
                ...
                <div className="relative z-10 flex flex-col h-full">
                   <div className="flex items-center gap-2 mb-6">
                      ...
                      <span className="text-[9px] font-black uppercase tracking-widest text-blue-400">AI Strategic Verdict</span>
                   </div>
                   <h4 className="text-xl font-black mb-4 leading-tight">حالة المشروع: <span className="text-blue-400">جاهز للاستثمار</span></h4>
                   <p className="text-slate-400 font-bold leading-relaxed text-[11px] mb-8 opacity-90">
                      مشروعك يتمتع بميزة "المحيط الأزرق". التوازن بين الكفاءة المالية وسرعة التنفيذ يجعلك الخيار الأول للمستثمرين.
                   </p>
                   <div className="mt-auto">
                      <button className="w-full py-4 bg-white text-slate-900 rounded-xl font-black text-xs shadow-lg hover:bg-blue-50 transition-all flex items-center justify-center gap-2">
