  ...
  return (
    <div className="py-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4 tracking-tight">خطط الأسعار</h2>
        <p className="text-gray-400 font-bold text-lg mb-10 max-w-2xl mx-auto">اختر الخطة التي تناسب حجم طموحاتك ومرحلة نمو مشروعك الحالية.</p>
      ...
      {/* Trust Footer */}
      <div className="mt-20 p-10 bg-white border border-gray-50 rounded-[3rem] text-center shadow-inner relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h4 className="text-xl font-bold text-gray-900">ضمان استرداد الأموال بنسبة 100%</h4>
          </div>
          <p className="text-gray-400 font-bold text-sm max-w-lg mb-8">نحن واثقون من جودة خدماتنا. إذا لم تكن راضياً عن تجربتك خلال أول 14 يوماً، سنعيد لك مبلغ الاشتراك بالكامل دون طرح أي أسئلة.</p>
