...
const config: SectorDashboardProps = {
  ...
  navItems: ['نظرة عامة', 'رؤى الصناعة', 'تغير المناخ', 'الكوارث الطبيعية', 'التمويل المناخي', 'نظرة إقليمية', 'التعريف'],
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start gap-4 p-6 bg-emerald-50 rounded-2xl border border-emerald-100">
            ...
            <div className="text-right flex-1">
              <p className="font-bold text-emerald-900">سندات خضراء واستثمارات الطاقة</p>
        ...
        <div className="space-y-6 text-right">
          ...
          <div className="p-6 border border-slate-100 rounded-3xl space-y-4">
             <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                <span className="bg-red-100 text-red-700 text-xs px-2 py-1 rounded-lg font-black">أعلى مخاطر بالترتيب</span>
                <span className="font-bold text-slate-900">مؤشر المخاطر العالمي 2024</span>
             </div>
